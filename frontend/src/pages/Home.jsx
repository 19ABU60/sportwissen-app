...
export default function Home() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
      ...
      >
        <Link to="/medien">
          <div className="p-4 rounded-xl bg-zinc-800/30 border border-zinc-700/50 hover:bg-zinc-800/50 hover:border-zinc-600 transition-all cursor-pointer flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-zinc-400 text-sm">Medienverwaltung</span>
            </div>
